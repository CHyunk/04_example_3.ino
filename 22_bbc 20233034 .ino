...
#define _DUTY_MAX 2308 // 2000
#define _DUTY_NEU 1422 // 1500
#define _DUTY_MIN 537 // 1000
...
float volt_to_distance(int a_value)
{
  ...
  return 1402 + -8.39 * a_value + 0.0176 * a_value * a_value + -1.24E-05 * a_value * a_value * a_value;
}
